...
<head>
    ...
    <title>Lapor | Puskesmas Pauh</title>
...
<body>
    ...
    <div class="shadow">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="profildinas" class="dropdown-toggle" data-toggle="dropdown">PROFIL PUSKESMAS <span class="caret"></span></a>
            ...
            <div class="row">
                <div class="col-md-8 card-shadow-2 form-custom">
                    <form class="form-horizontal" role="form" method="post" action="private/validasi">
                        ...
                        <div class="form-group">
                            <label for="tujuan" class="col-sm-3 control-label">Informasi</label>
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-random"></span></div>
                                    <select class="form-control" name="tujuan">
                                        ...
                                        <option value="3">Asuransi Lainnya</option>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container">
                <small>v-6.0 | Copyright &copy; Puskesmas Pauh Padang 2020</small>
            </div>
        </div>
        <!-- shadow -->
    </div>
