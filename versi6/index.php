...
<head>
    ...
    <title>Puskesmas Pauh Kota Padang</title>
    <link rel="shortcut icon" href="images/icon_flutter.png">
    <!-- Bootstrap CSS -->
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">
                        <img alt="Brand" src="images/icon_flutter.png" width="30" height="30">
                    </a>
                </div>
    ...
    <div id="mainCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="images/puskesmas_pauh1.jpg" alt="...">
                <div class="carousel-caption welcome">
                    <h2 class="animated bounceInRight">Selamat Datang</h2>
                    <h3 class="animated bounceInLeft">Website Pengaduan Masyarakat Puskesmas Pauh Kota Padang</h3>
                </div>
            </div>
            <div class="item">
                <img src="images/puskesmas_pauh_2.jpeg" alt="...">
                <div class="carousel-caption">
                    <h2 class="animated bounceInDown">Pejabat</h2>
                </div>
            </div>
            <div class="item">
                <img src="images/puskesmas_pedoman.jpg" alt="...">
                <div class="carousel-caption">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <a class="twitter-timeline" href="https://twitter.com/" data-width="500" data-height="300">Tweets by Puskesmas</a>
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <div class="fb-page" data-height="300" data-width="500" data-href="https://id-id.facebook.com/HCPAUH/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                <blockquote cite="https://www.facebook.com/" class="fb-xfbml-parse-ignore">
                                    <a href="https://www.facebook.com/">Puskesmas Pauh</a>
                                </blockquote>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item list-group-item-success"><a href="http:///">Website Pemerintah Padang</a></li>
                                <li class="list-group-item list-group-item-info"><a href="http://kominfo">Website Diskominfo Padang</a></li>
                                <li class="list-group-item list-group-item-warning"><a href="http:///">Website Dispendukcapil Padang</a></li>
                                <li class="list-group-item list-group-item-danger"><a href="http:///">Website Bappeda Padang</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Facebook Feed -->
    ...
    <footer class="footer text-center">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <p class="mb-0">
                    031-3095331 <br>
                    puskesmas@padang.go.id <br>
                    puskesmas.padang@gmail.com
                </p>
            </div>
        </div>
    </footer>
    ...
    <div class="copyright py-4 text-center text-white">
        <small>v-6.0 | Copyright &copy;Puskesmas Pauh Kota Padang 2020</small>
    </div>
    <!-- shadow -->
</div>
