...
<head>
    ...
    <title>Export - Pengaduan Puskesmas Pauh</title>
    <!-- Bootstrap core CSS-->
            ...
            buttons: [
                {
                    ...
                    customize: function ( win ) {
                        ...
                        .css( 'font-size', '10pt' )
                        .prepend(
                            '<img src="logo_puskes.jpg" style="opacity: 0.5; display:block;margin-left: auto; margin-top: auto; margin-right: auto; width: 100px;" />'
                        );
                    }
                },
                {
...
<body class="fixed-nav sticky-footer" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="index">Puskesmas Pauh</a>
        ...
        <footer class="sticky-footer">
            <div class="container">
                <div class="text-center">
                    <small>Copyright © Puskesmas Pauh 2020</small>
                </div>
            </div>
        </footer>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="text-align : center;">Copyright © Puskesmas Pauh 2020</p>
                    </div>
                    <div class="modal-footer">
