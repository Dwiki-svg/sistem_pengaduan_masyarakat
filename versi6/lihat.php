...
<head>
    ...
    <title>Lihat Pengaduan | Puskesmas Pauh</title>
        ...
        <div class="footer footer-bottom text-center">
            <div class="row">
                ...
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                            <a class="btn btn-outline-light btn-social text-center rounded-circle" href="https://www.facebook.">
